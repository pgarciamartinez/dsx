 ...
 */
public class UCISequenceClassificationSpark1 {

    private static final Logger log = LoggerFactory.getLogger(UCISequenceClassificationSpark1.class);
