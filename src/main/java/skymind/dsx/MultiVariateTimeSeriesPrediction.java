...
public class MultiVariateTimeSeriesPrediction {
    public static void main(String[] args) throws Exception{
        ...
        //INDArray input = Nd4j.create(new double[]{0.12977867,0.35294122,0.24590163,0.52727318,0.66666669,0.00229001,0.,0.,0.14889336,0.36764708,0.24590163,0.52727318,0.66666669,0.00381099,0.,0.,0.15995975,0.42647061,0.22950819,0.54545403,0.66666669,0.00533197,0.,0.},new int[]{3,1,8});
